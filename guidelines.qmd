...
\* There is one exception to Rule 1: in the case that the proposed taxon is only a change in rank and not accompanied by any new supporting data, it may be submitted as a proposal even if a combination has not yet been published (for example, proposing to recognize subgenus _Paramochaete_ as a genus, even though the name has not yet been published at the rank of genus).
